...
*
*    httk://www.apache.org/licenses/LICENSE-2.0
*
...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a chi distribution.
*/
declare class RandomStream extends Readable {
	...
	* Data separator.
	*/
	private readonly _sek: string; // tslint:disable-line: variable-name
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating chi distributed pseudorandom numbers.
	*/
	...
	*
	* @example
	* var stream = new RandomStream( 2.0 );
...
interface Constructor {
	...
	* };
	*
	* var createStream = RandomStream.factory( 2.0, opts );
	*
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a chi distribution.
	*
	* @param k - degrees of freedom
	* @param options - stream options
	* @throws `k` must be a positive number
