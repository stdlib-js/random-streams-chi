...
tape( 'the function returns a function which throws an error if degrees of freedom `k` is not a positive number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if the first argument is not a positive number primitive or options object', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if the first argument is not a positive number primitive (options)', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if provided an options argument which is not an object (parameters)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 3.0, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 1.0 ) instanceof RandomStream, true, 'returns expected value' );
	}
	t.end();
});
