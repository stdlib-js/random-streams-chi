...
tape( 'the function throws an error if degrees of freedom `k` is not a positive number primitive (options)', function test( t ) {
	var values;
	var i;
